...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    if (error.message.includes('quota') || error.message.includes('resource-exhausted')) {
      console.warn('Firestore quota exceeded. Consider implementing rate limiting.');
    }
  }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="text-sm text-gray-600 mb-4">
              {this.state.error?.message.includes('quota') || this.state.error?.message.includes('resource-exhausted')
