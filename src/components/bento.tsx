...
export function BentoCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative p-10  z-20 isolate mt-[-110px] h-[14rem] text-white " style={{ background: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.85) 30%, rgba(0,0,0,0.97) 100%)' }}>
        <h1>{eyebrow}</h1>
